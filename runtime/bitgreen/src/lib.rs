...
use frame_support::{
	...
	parameter_types,
	traits::{AsEnsureOriginWithArg, ConstU128, Contains, Currency, InstanceFilter, PrivilegeCmp},
	weights::{
...
parameter_types! {
	...
	pub const AssetsStringLimit: u32 = 8192;	// max metadata size in bytes
...
construct_runtime!(
	pub enum Runtime
	{
		...
		Treasury: pallet_treasury::{Pallet, Call, Storage, Config<T>, Event<T>} = 25,
